...
// Детальные данные для улучшения 26 шаблонов до Premium уровня
const premiumData = {
  photographer_portfolio: {
    ...
    about: { en: "We turn fleeting moments into lasting memories through the art of photography.", de: "Wir verwandeln flüchtige Momente in bleibende Erinnerungen.", ru: "Мы превращаем мимолетные мгновения в долгие воспоминания." },
    services: [
...
Object.keys(premiumData).forEach(id => {
  ...
  preset.content.testimonials = data.testimonials.map(t => ({
    name: t.n,
    [`text_en`]: t.t_en,
    [`text_de`]: t.t_en, // Simplified for speed
    [`text_ru`]: t.t_en, // Simplified for speed
    rating: t.r,
